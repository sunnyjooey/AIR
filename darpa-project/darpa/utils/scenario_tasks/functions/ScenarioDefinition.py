...
class GlobalParameters(Task):
    ...
    major_road_speed_offset = luigi.ChoiceParameter(
        default=0.0,
        choices=[-50.0, -25.0, 0.0, 25.0, 50.0, 75.0, 100.0],
        description="Offset road speed",
        var_type=float,
    )

    minor_road_speed_offset = luigi.ChoiceParameter(
        default=0.0,
        choices=[-30.0, -15.0, 0.0, 25.0, 50.0, 75.0, 100.0],
        description="Offset road speed",
        var_type=float,
    )
